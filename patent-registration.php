...
<h1 class="h1-title">Patent Registration</h1>
</div>
...
<li><a href="iso-registration.html" title="">Patent Registration</a></li>
</ul>
...
<p align="justify">Securing a patent registration is essential for safeguarding a design, innovation, or product meeting specific criteria of utility, ethics, and functionality. A patent extends protection to an invention for a span of 20 years, commencing upon filing by the individual.</p>
<br>
<p align="justify">Initiating patent registration involves submitting a formal application to the trademark office. The act of publicly introducing the item for sale and enabling its commercial utilization concludes upon publishing a description of the innovation.</p>
<br>
<p align="justify"> <u>Benefits of Patent Registration:</u></p><br>
<li>Establishing a public record for the company.</li>
<li>Authority to sue or file a complaint to the court in case of infringement.</li>
<li>Protection from duplication.</li>
<li>Rights to import, export, franchise or sell the patented work.</li>
<li>Exclusive rewards for the originality.</li>
<br>
<p align="justify">In Kolkata, RP Associates provides skilled and enhanced patent consultation services by utilising cutting-edge tactics. With expertise and honesty, we strive to offer the best client solutions.</p>
<br>
</div>
</div>
<div class="col-md-5">
<div class="title-section left">
<img src="images/services/patent-flowchart.jpg" alt="img2">
</div>
</div>
</div>
</div>
...
<h2>Important information about Patent</h2>
</div>
<div class="progress-content">
<p align="justify">There are various types of a patent application that needs to be understood, like:</p><br>
<li>Ordinary application</li>
<li>Convention application</li>
<li>Provision application</li>
<li>Patent of Addition</li>
<li>Divisional Application</li>
<li>National phase PCT Application</li><br>

<p align="justify">Steps to Get Your Patent Registration:</p><br>
<li>The foremost step is to do a patent search fore-filling up the application. As if the invention is found similar to any earlier arts then it may be challenged by the Indian Patent office.</li><br>
<li>The patent should be written in techno legal language. Give specifications of every detail like the area of the invention and the procedure of how it is made.</li><br>
<li>Then one is able to file an application to the Patent Registration in India. If no issues arise then you have to submit full specifications within 12 months.</li><br>
<li>Now you can advertise your invention in journals and wait if any objection arises. If it happens then the examiner will take suitable steps.</li><br>
<li>If no issues occurred or the examiner gets a valid reason, then the authorized body will grant the patent.</li><br>
</div>
</div>
</div>
</div>
...
<!-- Mirrored from www.rpassociates.com/patent-registration.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 11 Feb 2025 12:35:10 GMT -->
</html>